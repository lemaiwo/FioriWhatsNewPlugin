sap.ui.define([
	...
	return Object.extend("be.wl.fiori.news.service.CoreService", {
			...
			var core = {
				ajax: function (method, url, headers, args) {
					var promise = new Promise(function (resolve, reject) {
						...
						if (args.data && (method === 'POST' || method === 'PUT')) {
							// client.setRequestHeader("accept", "application/json");
							// client.setRequestHeader("content-type", "application/json");
							var data = {};
							for (var keyp in args.data) {
								if (args.data.hasOwnProperty(keyp)) {
									data[keyp] = args.data[keyp];
								}
							}
						}
						...
						client.responseType = args.responseType || 'json';
						if (data) {
